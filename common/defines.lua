...
NEngine = {
	...
	MISSING_SCRIPTED_SUCCESSOR_ERROR_CUTOFF_YEAR = 1002, -- The missing scripted successor error will not be shown before this date
	MISSING_SCRIPTED_SUCCESSOR_ERROR_CUTOFF_MONTH = 7,
	MISSING_SCRIPTED_SUCCESSOR_ERROR_CUTOFF_DAY = 12,
